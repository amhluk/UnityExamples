...
//move cube horizontally, vertically or diagonally 
function MoveCube ()
{
	...
	if (xCoordinate == Screen.width/80 && translateX == 1) {
		translateX = -1;
	} else if (xCoordinate == -Screen.width/80 && translateX == -1) {
		translateX = 1;
	}
	if (yCoordinate == Screen.width/80 && translateY == 1) {
		translateY = -1;
